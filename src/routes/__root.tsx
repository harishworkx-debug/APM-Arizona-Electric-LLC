...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Residential electrical service information helping Phoenix Metro homeowners connect with independent local providers." },
      { property: "og:description", content: "Residential electrical service information helping Phoenix Metro homeowners connect with independent local providers." },
